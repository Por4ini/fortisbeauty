...
class Languages(models.Model):
    ...
    class Meta:
        verbose_name = _('Активный язык')
        verbose_name_plural = _('Активные языки')
...
class Language(models.Model):
    translate = models.BooleanField(default=True, verbose_name=_("Перевести"))
    language =  models.ForeignKey('core.Languages', blank=False, on_delete=models.CASCADE, verbose_name=_("Язык"))
...
class Translation(models.Model):
    translate_childs = models.BooleanField(default=False, verbose_name=_("Перевод"))
