...
class Attribute(NameSlug):
    name =  models.CharField(max_length=250, blank=False, verbose_name=_("Название"), unique=True)
...
class AttributeValue(NameSlug):
    ...
    name =   models.CharField(max_length=250, blank=False, verbose_name=_("Название"))
    slug =   models.CharField(max_length=250, blank=True, null=True, verbose_name=_("Иденитификатор"), editable=False)
...
class CategoryAttribute(models.Model):
    parent =         models.ForeignKey('shop.Categories',  on_delete=models.CASCADE, related_name='attributes', verbose_name=_("Катгория"))
...
class ProductAttribute(models.Model):
    parent =    models.ForeignKey('shop.Product',    on_delete=models.CASCADE, related_name='product_attrs')
